...
/* Simone 31/03/2015 17:00 */

class PgSqlConfigFix(
    val enableLocalTrust: Boolean = false
    , private val bindAnyAddress: Boolean = false
) : IPgSqlConfigFix {
...
s
        FileUtils.write(
            ...
            "$hbaContent\n" +
                    ...
                    if (enableLocalTrust) "\nlocal    all             all                              trust" else ""
        )
    }
}
// below also pg_hba.conf
